...
const std::string MODEL_PATH = "/Users/bowenzou/Workspace/Documents/games-vulkan/tutorial/src/models/viking_room.obj";
const std::string TEXTURE_PATH = "/Users/bowenzou/Workspace/Documents/games-vulkan/tutorial/src/textures/viking_room.png";
...
struct Vertex {
    ...
    static std::array<VkVertexInputAttributeDescription, 3> getAttributeDescriptions() {
        ...
        attributeDescriptions[0].format = VK_FORMAT_R32G32B32_SFLOAT;  // float: VK_FORMAT_R32_SFLOAT  vec2: VK_FORMAT_R32G32_SFLOAT  vec3: VK_FORMAT_R32G32B32_SFLOAT  vec4: VK_FORMAT_R32G32B32A32_SFLOAT
...
#error Unknown Compiler
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("/Users/bowenzou/Workspace/Documents/games-vulkan/tutorial/src/shader/generated/spv/shader.vert.spv");
        auto fragShaderCode = readFile("/Users/bowenzou/Workspace/Documents/games-vulkan/tutorial/src/shader/generated/spv/shader.frag.spv");
    ...
    void createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory) {
        ...
        if (vkAllocateMemory(device, &allocInfo, nullptr, &bufferMemory) != VK_SUCCESS) {
            throw std::runtime_error("failed toallocate vertex buffer memory!");
        }
    ...
    void createTextureImage() {
        ...
        createBuffer(imageSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, stagingBuffer, stagingBuferMemory);
        ...
        transitionImageLayout(textureImage, VK_FORMAT_R8G8_SRGB, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, 1);
        copyBufferToImage(stagingBuffer, textureImage, static_cast<uint32_t>(texWidth), static_cast<uint32_t>(texHeight));
        
        transitionImageLayout(textureImage, VK_FORMAT_R8G8_SRGB, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, mipLevels);
    ...
    void createTextureSampler() {
        ...
        if (vkCreateSampler(device,  &samplerInfo, nullptr, &textureSampler) != VK_SUCCESS) {
            throw std::runtime_error("failed to creaete texture sampler!");
        }
    }
    ...
    void createImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkSampleCountFlagBits numSamples, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory) {
        ...
        if (vkAllocateMemory(device, &allocInfo, nullptr, &imageMemory) != VK_SUCCESS) {
            throw std::runtime_error("failed to allcate image memory!");
        }
